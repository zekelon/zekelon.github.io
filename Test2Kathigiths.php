...
<div id="container">
   <h1></h1>
   <form action="StoppedTests2.php" method="POST">
 <fieldset style="background-color:LimeGreen; display: inline-block;">
   ...
   <tr>
	<?php   //Magia
			...
			$result = mysqli_query($link,"select * from testnames WHERE kathigiths='TestKathigiths'") or die("Unable to query database Spiti soy".mysqli_error());
